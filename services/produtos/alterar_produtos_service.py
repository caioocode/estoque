...
def alterar_produtos_service(id: str, produto: Produto):
    try:
        ...
        quantidade_antiga = produto_antigo[0]  # Acesse o valor corretamente
        ...
        diferenca = produto.quantidade_estoque - quantidade_antiga
        if diferenca > 0:
